...
import com.petshop.jwt.config.JwtService;
...
import com.petshop.jwt.token.TokenType;
import com.petshop.jwt.user.User;
import com.petshop.jwt.user.UserRepository;
...
public class AuthenticationService {
  ...
  public void refreshToken(
    ...
    if (userEmail != null) {
      var user = this.repository.findByCpf(userEmail)
              .orElseThrow();
